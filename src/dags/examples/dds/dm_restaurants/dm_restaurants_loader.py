...
class DmRestaurantsOriginRepository:
    ...
    def dm_list_restaurants(self, restaurant_threshold: int, limit: int) -> List[DmRestaurantObj]:
...
class DmRestaurantDestRepository:
    ...
    def insert_restaurant(self, conn: Connection, restaurant: DmRestaurantObj) -> None:
...
class DmRestaurantLoader:
    ...
    def dm_load_restaurants(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.origin.dm_list_restaurants(last_loaded, self.BATCH_LIMIT)
            ...
            for dm_restaurant in load_queue:
                self.dds.insert_restaurant(conn, dm_restaurant)
